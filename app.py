...
def test16():
    test16 = "test16"
    return make_response("test16", test16)

@app.route('/test17')
def test17():
    test17 = "test17"
    return make_response("test17", test17)

@app.route('/test18')
def test18():
    test18 = "test18"
    return make_response("test18", test18)

@app.route('/test19')
def test19():
    test19 = "test19"
    return make_response("test19", test19)

@app.route('/test20')
def test20():
    test20 = "test20"
    return make_response("test20", test20)
